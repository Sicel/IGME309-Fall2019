...
class MyCamera
{
	...
	/*
	USAGE: Helper Method - Changes camera pitch
	ARGUMENTS: float vertical -> angle of rotation (in radians)
	OUTPUT: ---
	*/
	void MyCamera::RotatePitch(float vertical);

	/*
	USAGE: Helper Method - Changes camera yaw
	ARGUMENTS: float horizontal -> angle of rotation (in radians)
	OUTPUT: ---
	*/
...
public:
	...
	*/
	...
	USAGE: Translates the camera right or left
	ARGUMENTS: 
	-	float horizontal -> rotaion amount about horizontal axis (in radians)
	-	float vertical -> rotaion amount about vertical axis (in radians)
	OUTPUT: ---
	*/
